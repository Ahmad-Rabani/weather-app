  ...
  return (
    <>
      <div className="w-[90%] bg-white rounded-xl p-4 flex justify-center items-center flex-col dark:bg-slate-950">
        ...
        <br />
        <div className="flex w-full mt-3 justify-evenly flex-wrap gap-4 max-md:w-1/2 max-sm:overflow-x-scroll max-sm:scroll-smooth max-sm:w-full max-sm:flex-nowrap">
